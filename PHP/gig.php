<html>
    ...
    <nav class="container row m-3" aria-label="breadcrumb">
        <ol class="breadcrumb mt-3">
            ...
            <li class="breadcrumb-item active" aria-current="page">Submit Gig</li>
        </ol>
    </nav>
<?php
session_start();
...
if($bdd->errorInfo()[2]){
  ...
  <a href="../pages/profile.php" class=" m-4 btn btn-danger">Back To Profile page</a>
  ') ;
}else{
    echo('<div class="m-4 alert alert-success" role="alert">
   Gig Uploaded Successfully ! 
  </div>
  <a href="../pages/profile.php" class=" m-4 btn btn-success">Back To Profile page</a>
  ') ;
}
?>
<!-- Footer -->
