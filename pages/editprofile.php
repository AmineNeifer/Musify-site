...
<body>
    ...
    <form class="container row m-3" action="../PHP/profileupdate.php?id=<?=$_SESSION['id']?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                    <a class="mx-3 col-md-3 mt-4 mb-3 btn btn-outline-secondary" href="changepassword.php">Chnage Password Here</a>
                    </div>
                    <div class="col-md-6">
                        <label for="artist" class="form-label">Artist Name</label>
                        <input type="text" class="form-control" id="artist" name="artist" value="<?=$edit->artname;?>"
                            placeholder="Jony">
                    </div>
                    <div class="col-md-6">
